...
export const Footer: React.FC<FooterProps> = ({ config }) => {
  ...
  return (
    <footer className="border-t border-zinc-800/80 bg-zinc-950 text-zinc-400 text-xs font-sans pt-12 pb-16">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pb-8 border-b border-zinc-900">
          ...
          <div className="flex items-center gap-6 font-mono text-xs">
            <button
              ...
              className="text-zinc-400 hover:text-indigo-400 transition-colors underline-offset-4 hover:underline"
            >
        ...
        <div className="py-8 space-y-3 text-[11px] leading-relaxed text-zinc-400 border-b border-zinc-900">
          <p>
            <strong>Aviso de exención de responsabilidad de Meta Platforms:</strong> Este sitio web no forma parte del sitio web de Facebook ni de Meta Platforms, Inc. Asimismo, este sitio no está respaldado ni certificado por Meta de ninguna manera. FACEBOOK es una marca comercial registrada de META PLATFORMS, INC.
          </p>
          <p>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] font-mono text-zinc-400">
          ...
          <span className="text-zinc-400">Infraestructura Segura SSL 256-bit</span>
        </div>
      </div>
