...
export const DisqualifiedStep: React.FC<DisqualifiedStepProps> = ({
  ...
  return (
    <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-6 sm:p-10 shadow-2xl text-center">
      <div className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-2xl border border-zinc-800 bg-zinc-900/60">
      ...
      <p className="mx-auto max-w-lg text-sm text-zinc-300 leading-relaxed mb-8">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
        <a
          ...
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-emerald-500 shadow-lg shadow-emerald-950 active:scale-95"
        >
